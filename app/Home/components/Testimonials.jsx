...
export default function Testimonials() {
  ...
  const testimonials = [
    ...
    },
    {
      ...
      role: "Chief Student Coordinator, IIC 8.0",
      text: "Leading the activities of IIC has been a truly rewarding experience. This platform has not only enabled us to foster innovation and entrepreneurship but also strengthened our teamwork and leadership skills. I sincerely thank the faculty mentors and my peers for their unwavering support in making this journey impactful.",
      avatar: "MC",
      bgColor: "bg-green-500",
    },
    {
      id: 7,
      name: "Vivek Tiwari",
      role: "Vice Chief Coordinator, IIC 8.0",
      text: "Serving as Vice Chief Coordinator has been both an honor and a learning journey. The activities of IIC have empowered students to think creatively, embrace entrepreneurship, and connect with real-world challenges. I am confident that our collective efforts will inspire many more innovative pursuits ahead ",
      avatar: "AK",
    ...
    },
    {
      id: 8,
      name: "Manohar Jha",
      role: "Secretary, IIC 8.0",
      text: "In my role as Secretary, I have had the privilege of supporting the smooth execution of the council's programs and events. This experience has reinforced the value of coordination, collaboration, and commitment in achieving shared goals. I am grateful to the mentors and fellow coordinators for their constant guidance and encouragement throughout this journey.",
      avatar: "LM",
      bgColor: "bg-teal-600",
    },
